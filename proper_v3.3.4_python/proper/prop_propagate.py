...
#  Modified June 2025 by J. Krist - beam radius rather than beam diameter was being stored for TABLE option - fixed
...
def prop_propagate(wf, dz, surface_name = "", **kwargs):
    ...
    if proper.do_table:
        ...
        proper.beam_diam_list[proper.action_num] = 2 * proper.prop_get_beamradius(wf)
