    ...
    **Validates: Requirements 4.1, 4.3, 4.4, 4.5, 4.6, 4.7, 4.8**
    ...
    def propagate(
        ...
        **Validates: Requirements 4.1, 4.3, 4.4, 4.5, 4.6, 4.7, 4.8**
        ...
        # 使用 PROPER 执行传播
        # 修正：PROPER 假设真空传播。在介质 n 中传播物理距离 d，
        # 等效于在真空中传播 d/n 的衍射效应。
        current_n = state.pilot_beam_params.current_refractive_index
        distance_m = distance_mm * 1e-3
        effective_distance_m = distance_m / current_n
        
        proper.prop_propagate(state.proper_wfo, effective_distance_m)
    ...
    def propagate_distance(
        ...
        **Validates: Requirements 4.3, 4.4**
        ...
        current_n = state.pilot_beam_params.current_refractive_index
        distance_m = distance_mm * 1e-3
        proper.prop_propagate(state.proper_wfo, distance_m / current_n)
