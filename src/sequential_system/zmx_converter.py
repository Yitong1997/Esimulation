...
class ElementConverter:
    ...
    def _create_mirror_element(
        ...
        **Validates: Requirements 5.1, 5.2, 5.3, 5.7, 5.8**
        ...
        # 规则 0: explicitly biconic surface type
...
class CodeGenerator:
    ...
    def _get_element_params(
        ...
        **Validates: Requirements 9.3**
        ...
        elif element_type == "BiconicMirror":
            params.append(("radius_x", element.radius_x))
            params.append(("radius_y", element.radius_y))
            params.append(("conic_x", element.conic_x))
            params.append(("conic_y", element.conic_y))
